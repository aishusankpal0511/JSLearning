...
console.log(arrayOfNumbers);
console.log("====only one element delete splice=======");
var arrayOfNumbers = [ 10, 20, 25, 15, 40, 45];
arrayOfNumbers.splice(3,1)
console.log(arrayOfNumbers);
console.log("====only two element delete splice=======");
var arrayOfNumbers = [ 10, 20, 25, 15, 40, 45];
arrayOfNumbers.splice(1,2)
console.log(arrayOfNumbers);

console.log("======= splice() Insert one element without replacing==================");
var arrayOfNumbers = [ 10, 20, 25, 15, 40, 45];
arrayOfNumbers.splice(2,0,22);
console.log(arrayOfNumbers);

console.log("======= splice() Insert multiple element without replacing==================");
var arrayOfNumbers = [ 10, 20, 25, 15, 40, 45];
//5,35,55
