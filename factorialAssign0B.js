function factorialofWordsCount(str) {
  ...
  if (str == "null" || str == "NaN" || str == "undefined" || str== "" || str == "0") {
...
var output = factorialofWordsCount("My Name is Aishwarya Ashok Jadhav");
console.log(`Total word count of "My Name is Aishwarya Ashok Jadhav" : 6
Factorial of 6 is :  ${output}`);
...
var output = factorialofWordsCount("0");